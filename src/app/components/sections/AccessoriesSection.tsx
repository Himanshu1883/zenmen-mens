...
const AccessoriesSection = () => {
  ...
  const allHref = ACCESSORIES_COLLECTION_HREF;
  const tieHref = accessoryCollectionHref("tie", groups);
  const broochHref = accessoryCollectionHref("brooch", groups);
  const buttonHref = accessoryCollectionHref("button", groups);
  ...
  const accessories = [
    {
      ...
      price: "From ₹2,500",
      image:
        "https://i.pinimg.com/736x/44/4e/96/444e96341bab6594a6f14d9d731af270.jpg",
      items: "50+ Designs",
      href: tieHref,
    },
    {
      ...
      price: "From ₹1,800",
      image:
        "https://i.pinimg.com/736x/c3/67/0b/c3670bdc7b99e3553e75831c418f8cce.jpg",
      items: "30+ Styles",
      href: broochHref,
    },
    {
      ...
      price: "From ₹1,200",
      image:
        "https://i.pinimg.com/736x/8a/e3/d1/8ae3d160a3bb65b43478bcd22e79d32e.jpg",
      items: "40+ Options",
      href: buttonHref,
    },
  ];
  ...
  const featuredAccessories = [
    {
      ...
      price: "₹3,200",
      image:
        "https://i.pinimg.com/1200x/e0/8e/b4/e08eb476405e395cf40fa816a4098343.jpg",
      href: tieHref,
    },
    {
      ...
      price: "₹4,500",
      image:
        "https://images.unsplash.com/photo-1603561596112-0a132b757442?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
      href: broochHref,
    },
    {
    ...
    },
    {
      ...
      price: "₹2,800",
      image:
        "https://i.pinimg.com/1200x/1b/a3/c8/1ba3c8ab4b19e55a2bacba1014bcc931.jpg",
      href: tieHref,
    },
  ];
    ...
    <section className="py-20 md:py-32 bg-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              <Link
                href={allHref}
                className="no-underline text-inherit hover:text-[#7da8c7] transition-colors duration-300"
              >
                Luxury Accessories
              </Link>
            </h2>
            ...
            <Link href={allHref} className="inline-block no-underline">
              <motion.span
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-block px-10 py-4 bg-[#0f172a] text-white text-[11px] tracking-[0.2em] uppercase hover:bg-[#7da8c7] transition-all duration-300 rounded-sm font-medium"
              >
              ...
              >
                <div className="relative h-[280px] md:h-[350px] rounded-lg overflow-hidden mb-4 bg-[#f8fafc]">
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <span className="px-6 py-2.5 bg-white text-[#0f172a] text-[10px] tracking-[0.2em] uppercase font-medium rounded-sm">
                      Quick View
                    </span>
                  </div>
                </div>
        ...
        <div className="text-center mt-12">
          <Link href={allHref} className="inline-block no-underline">
            <motion.span
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block px-10 py-4 border-2 border-[#0f172a] text-[#0f172a] text-[11px] tracking-[0.2em] uppercase hover:bg-[#0f172a] hover:text-white transition-all duration-300 rounded-sm font-medium"
            >
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-8 lg:px-16 mt-20 md:mt-32">
        ...
        >
          ...
          <Link href="/appointment" className="inline-block no-underline">
            <motion.span
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block px-10 py-4 bg-[#7da8c7] text-white text-[11px] tracking-[0.2em] uppercase hover:bg-[#6b97b7] transition-all duration-300 rounded-sm font-medium"
            >
              Learn More
            </motion.span>
          </Link>
